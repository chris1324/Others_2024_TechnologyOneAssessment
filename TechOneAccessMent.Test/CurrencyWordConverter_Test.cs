...
namespace TechOneAccessMent.Test
{
    public class CurrencyWordConverter_Test
    {
        ...
        [InlineData("201.21", "TWO HUNDRED ONE DOLLARS AND TWENTY-ONE CENTS")]
        [InlineData("290.21", "TWO HUNDRED AND NINETY-ONE DOLLARS AND TWENTY-ONE CENTS")]
        [InlineData("291.21", "TWO HUNDRED NINETY-ONE DOLLARS AND TWENTY-ONE CENTS")]
        // Thousand dollars
        [InlineData("1,000.00", "ONE THOUSAND DOLLARS")]
        [InlineData("2,013.00", "TWO THOUSAND AND THIRTEEN DOLLARS")]
        [InlineData("2,900.21", "TWO THOUSAND NINE HUNDRED DOLLARS AND TWENTY-ONE CENTS")]
        [InlineData("2,913.21", "TWO THOUSAND NINE HUNDRED DOLLARS AND THIRTEEN DOLLARS AND TWENTY-ONE CENTS")]
